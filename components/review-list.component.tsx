            ...
            <div className='flex flex-row gap-5 mt-5 items-center'>
              ...
              <div className='flex flex-col justify-center items-start'>
                <div className='flex flex-row justify-between gap-4 items-center'>
                  ...
                  <h2 className='text-sm'>{review.author_details.rating.toFixed(1)}/10</h2>
                </div>
                <p className='text-white text-[0.8rem] line-clamp-4 md:max-w-[500px] md:mt-2 text-justify leading-6'>{review.content}</p>
              </div>
            </div>
          ))}
        </div>
